...
All thoughts here are some local state of my awareness in develpment,
along the idea of verification_falsification and dogma_is_wrong.
Mostly this is quite useless stuff. I'm just learning.

:information_is_time_is_action: *Action = information = time = space = spacetime*.
  I also call this a *variable*; a time step is a value.
  Physical existence_by_change: Space does not exist without change.
...
:world_of_tiers: Even physics concepts like energy are per layer. Little information leaves local cycles up the tiers.
:no_infinity: infinity is not physical (and mathematical continuity, neither)
:mind_variable:  Mind variables are not phyisical variables. Mind concepts are often just parroting (of propaganda).
:intelligence_is_control: Maxwell demon to harvest energy lost by lower cycles/layers. A cooling process.
...
.. Entropy, Maxwell demon, Landauer limit
.. information_is_time_is_action
.. world_of_tiers

| https://rolandpuntaier.blogspot.com/2019/05/economy-as-dynamic-system.html
| ./economy.rest

.. economy comparison to evolution, physics
.. ethics_of_control
...
| ./from_concepts_to_computing.rst
...
| ./individualism_democracy.rst

.. no power concentration, no taxes, local individual control
.. ethics_of_control
